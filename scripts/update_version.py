...
def main():
  ...
  plistpath = scriptpath + "/resources/Eightyfier-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Eightyfier-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Eightyfier-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Eightyfier-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Eightyfier-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Eightyfier.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Eightyfier.iss",inplace=1):
