...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Eightyfier Demo Installer\n"
      else:
        line="OutputBaseFilename=Eightyfier Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Eightyfier Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Eightyfier installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Eightyfier Demo installer\n"
     else:
       line="SetupWindowTitle=Eightyfier installer\n"
